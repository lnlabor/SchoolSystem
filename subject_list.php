...
<body>
    <main class="container">
        ...
        <table>
            <tr><th>Code</th><th>Title</th><th>Unit</th><th>Action</th></tr>
            <?php if($result && $result->num_rows>0): ?>
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php $u = current_user(); if(in_array($u['account_type'], ['admin','staff'])): ?><a href="subject_edit.php?subject_id=<?php echo intval($row['id']); ?>">Edit</a><?php else: ?>-<?php endif; ?></td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
